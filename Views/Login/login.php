...
<body>
  <?php
  getModal('modalUsuariosExterior', $data);
  ?>
  ...
  <section class="login-content">
    ...
    <div class="login-box">
      ...
      <form class="login-form" name="formLogin" id="formLogin" action="">
        ...
        <br>
        <div class="form-group btn-container">
          <button class="btn btn-primary btn-block" type="button" onclick="openModal();"><i class="fas fa-plus-circle"></i> REGISTRARSE</button>
          </h1>
        </div>
      </form>
